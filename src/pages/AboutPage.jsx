        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center">
            ...
            <p className="text-lg max-w-lg text-gray-300 leading-relaxed mx-auto md:mx-0 text-center md:text-left">
              Student Sphere is a cutting-edge platform designed to streamline academic management, enhance communication between students, teachers, and administrators, and empower students on their educational journey.
            </p>
          </div>
  
          {/* Right Section */}
          <div className="w-full md:w-1/2 flex flex-col gap-10 justify-center relative">
            ...
            <img 
              src="/background.jpg" 
              alt="Decorative" 
              className="absolute top-0 left-0 w-full h-full object-cover opacity-30 rounded-lg z-0" 
            />
          </div>
        </div>
      </div>
